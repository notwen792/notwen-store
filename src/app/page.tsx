                    ...
                    <ul className="space-y-4">
                        <li className="flex items-center gap-4 bg-background/50 p-3 rounded-lg group transition-colors hover:bg-background/80">
                            <Avatar className="transition-transform duration-300 group-hover:rotate-12">
                                <AvatarImage src="https://media.discordapp.net/attachments/1269644412875440128/1464991511300149404/WgAd3pVL_400x400.jpg?ex=69777b2a&is=697629aa&hm=44ccff30d3444d31d0bb3c9029b2b007cec3a4143fec8a655f385b33cb762f97&=&format=webp" alt="stewiexox" />
