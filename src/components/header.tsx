...
export function Header() {
  return (
    <header className="p-4 pr-8 flex justify-end items-center h-20 border-b border-border">
      <Button variant="outline" asChild className="text-sm uppercase hover:bg-gradient-to-r from-destructive to-[hsl(var(--chart-1))] hover:text-primary-foreground hover:border-transparent transition-colors">
